            ...
            <div class="row">
               <div class="col-sm-12 col-md-6 col-lg-7 order-sm-1 order-2 primary-menu-tm">
                  <nav class="navbar navbar-expand-lg navbar-light bg-light">
                     <a class="navbar-brand" href="#"><strong>E-WORK</strong></a>
                     ...
                     <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                           ...
                           <li class="nav-item dropdown">
                              <a class="nav-link dropdown-toggle" href="{{ url('browse-jobs') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Find Work</a>
                              <ul class="dropdown-menu">
                                 <li class="nav-item dropdown"><a class="dropdown-item" href="{{ url('browse-jobs') }}">Browse Projects</a></li>
                              </ul>
                           </li>
                           <li class="nav-item dropdown">
                              <a class="nav-link" href="blog-page-right-sidebar.html" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog</a>
                        ...
                        <form class="form-inline my-2 my-lg-0"> 
                           <input class="form-control mr-sm-2" type="search" placeholder="&#xed60;  Find Freelancer" aria-label="Search" data-toggle="modal">
                        </form>
                     </div>
                  </nav>
               </div>
               ...
               <div id="rev_slider_26_1" class="rev_slider fullscreenbanner tiny_bullet_slider" style="display:none;" data-version="5.4.1">
                  <ul>
                     ...
                     <li data-index="rs-73" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="http://works.themepunch.com/revolution_5_3/wp-content/"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="../img/slider/transparent.png" data-bgcolor='linear-gradient(90deg, rgba(134,143,150,1) 0%, rgba(89,97,100,1) 100%)' style='background:linear-gradient(90deg, rgba(134,143,150,1) 0%, rgba(89,97,100,1) 100%)' alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" 
                           ...
                           style="z-index: 6;"><img src="img/slider/macbook.jpg" alt="" data-ww="['1000px','1000px','800px','500px']" data-hh="['563px','563px','450','281']" width="1200" height="675" data-no-retina> </div>
                        <!-- LAYER NR. 3 -->
                        ...
                        <div class="tp-caption   tp-resizeme" 
                           ...
                           data-paddingleft="[20,20,20,20]"
                           style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Complete UI/UX Toolkit for Marketplace</div>
                     </li>
                     <!-- SLIDE  -->
                     <li data-index="rs-74" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="http://works.themepunch.com/revolution_5_3/wp-content/"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="../img/slider/transparent.png" data-bgcolor='linear-gradient(120deg, rgba(203,186,204,1) 0%, rgba(36,57,73,1) 100%)' style='background:linear-gradient(120deg, rgba(203,186,204,1) 0%, rgba(36,57,73,1) 100%)' alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 5 -->
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" 
                           id="slide-74-layer-1" 
                           ...
                           data-paddingbottom="[0,0,0,0]"
                           data-paddingleft="[0,0,0,0]"
                           style="z-index: 5;"><img src="img/slider/blume.jpg" alt="" data-ww="['1000px','1000px','800px','500px']" data-hh="['563px','563px','450px','281px']" width="1200" height="675" data-no-retina> </div>
                        <!-- LAYER NR. 6 -->
                        <div class="tp-caption rev-btn  tp-resizeme" 
                           id="slide-74-layer-4" 
                     ...
                     <li data-index="rs-75" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="http://works.themepunch.com/revolution_5_3/wp-content/"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" 
                           ...
                           data-paddingbottom="[0,0,0,0]"
                           data-paddingleft="[0,0,0,0]"
                           style="z-index: 5;"><img src="img/slider/krokodil.jpg" alt="" data-ww="['1000px','1000px','800px','800px']" data-hh="['563px','563px','450px','450px']" width="1200" height="675" data-no-retina> </div>
                        <!-- LAYER NR. 10 -->
                        <div class="tp-caption   tp-resizeme" 
                           id="slide-75-layer-2" 
                           data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                           ...
                           data-paddingbottom="[30,30,30,30]"
                           data-paddingleft="[20,20,20,20]"
                           style="z-index: 6; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Complete payment system with milestone </div>
                        <!-- LAYER NR. 11 -->
                        <div class="tp-caption   tp-resizeme" 
                           id="slide-75-layer-3" 
                           data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                     ...
                     <li data-index="rs-76" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="http://works.themepunch.com/revolution_5_3/wp-content/"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" 
                           ...
                           data-paddingbottom="[0,0,0,0]"
                           data-paddingleft="[0,0,0,0]"
                           style="z-index: 5;"><img src="img/slider/birds.jpg" alt="" data-ww="['1000px','1000px','800px','800px']" data-hh="['563px','563px','450px','450px']" width="1200" height="675" data-no-retina> </div>
                        <!-- LAYER NR. 14 -->
                        <div class="tp-caption   tp-resizeme" 
                           id="slide-76-layer-2" 
                           data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
               ...
               <div class="row">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-6">
                     <p class="how-it-works-text">Post your project and receive competitive bids from freelancers within minutes. Our reputation system will make it easy to find the perfect freelancer for your job. It's the simplest and safest way to get work done online.
                        We have millions of Freelancers for thousands of freelance jobs: from web design, mobile app development, virtual assistants, product manufacturing and graphic design. 
                     </p>
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-6">
                     <img class="ipad-img" src="img/works/how-it-works.jpg" alt=""/>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="success-stories">
               ...
               <div class="row">
                  <div class="col-sm-12 col-md-12 col-lg-7">
                     <div class="success-item" style="background-image:url(img/success/success1.jpg)">
                        <div class="success-wrapper">
                           ...
                           <div class="sucess-user">
                              <img src="img/success/user1.jpg" alt="">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-4">
                     <div class="success-item" style="background-image:url(img/success/success3.jpg)">
                        <div class="success-wrapper">
                           <h3><a href="#">Blog writing for your awesome website.</a></h3>
                           <a href="" class="button-ymp">Find writers</a>
                           <div class="sucess-user">
                              <img src="img/success/user3.jpg" alt="">
                              <div class="success-user-details">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-4">
                     <div class="success-item" style="background-image:url(img/success/success4.jpg)">
                        <div class="success-wrapper">
                           <h3><a href="#">Custom t-shirt illustration for ThemeMom</a></h3>
                           <a href="" class="button-ymp ">Find Illustrator</a>
                           <div class="sucess-user">
                              <img src="img/success/user4.jpg" alt="">
                              <div class="success-user-details">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-4">
                     <div class="success-item" style="background-image:url(img/success/success5.jpg)">
                        <div class="success-wrapper">
                           <h3><a href="#">Build an eCommerce website</a></h3>
                           <a href="" class="button-ymp">Find Developer</a>
                           <div class="sucess-user">
                              <img src="img/success/user5.jpg" alt="">
                              <div class="success-user-details">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12">
                     <div class="success-item" style="background-image:url(img/success/success6.jpg)">
                        <div class="success-wrapper">
                           ...
                           <div class="sucess-user">
                              <img src="img/success/user6.jpg" alt="">
                              <div class="success-user-details">
               ...
               <div id="rev_slider_491_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
                  <ul>
                     ...
                     <li data-index="rs-1704" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="1500" data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="img/slider/transparent.png" data-bgcolor="#d6adad" alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption tp-resizeme fullscreenvideo rs-parallaxlevel-10 tp-videolayer" 
                           ...
                           data-vimeoid="131379560" data-videoattributes="background=1&title=0&byline=0&portrait=0&api=1" data-videowidth="100%" data-videoheight="100%" data-videoloop="none" data-forceCover="1" data-aspectratio="4:3"			
                           data-textAlign="['left','left','left','left']"
                           data-paddingtop="[0,0,0,0]"
                           data-paddingright="[0,0,0,0]"
                           data-paddingbottom="[0,0,0,0]"
            ...
            <div class="featured">
               <div class="row">
                  ...
                  <div class="col-sm-12 col-md-2 col-lg-2 mobile-padding">
                     <a href="#"><img src="img/featured/featured1.png" alt=""></a>
                  </div>
                  <div class="col-sm-12 col-md-2 col-lg-2 mobile-padding">
                     <a href="#"><img src="img/featured/featured2.png" alt=""></a>
                  </div>
                  <div class="col-sm-12 col-md-2 col-lg-2 mobile-padding">
                     <a href="#"><img src="img/featured/featured3.png" alt=""></a>
                  </div>
                  <div class="col-sm-12 col-md-2 col-lg-2 mobile-padding">
                     <a href="#"><img src="img/featured/featured4.png" alt=""></a>
                  </div>
                  <div class="col-sm-12 col-md-2 col-lg-2 mobile-padding">
                     <a href="#"><img src="img/featured/featured5.png" alt=""></a>
                  </div>
                  <div class="col-sm-12 col-md-2 col-lg-2 mobile-padding">
                     <a href="#"><img src="img/featured/featured6.png" alt=""></a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <footer id="footer" class="margin-top">
                     ...
                     <div class="contact">
                        <ul>
                           ...
                           <li>
                              ...
                              <a href="mailto:hq@thememom.com">hq@thememom.com</a>
                           </li>
                        </ul>
                     </div>
         ...
         <div id="copyright">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12 col-md-12 col-lg-12">
                     <p class="copyright">© 2018 <a href="#">Yes Market Place</a> International Limited | Developed by <a href="https://thememom.com" title="ThemeMom" target="_blank">ThemeMom</a> </p>
                  </div>
               </div>
            </div>
         </div>
